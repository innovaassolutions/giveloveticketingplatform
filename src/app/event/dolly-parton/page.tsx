...
export default function DollyPartonEventPage() {
  ...
  const eventData = {
    ...
    date: '2025-09-28',
    time: '7:30 PM',
    description: 'Experience Dolly Parton\'s timeless classics in an intimate setting.',
    totalTickets: 4400,
    soldTickets: 3200
  };
    ...
    return [
      {
        ...
        description: 'Seated access to the main floor'
      },
      {
        id: 'vip',
        name: 'VIP Package',
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl text-pink-200 mb-4">{artist.name}</p>
                      ...
                      {cartItem ? (
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="w-8 h-8 rounded-full bg-pink-600 hover:bg-pink-700 disabled:bg-white/10 flex items-center justify-center text-white transition-colors"
                          >
                        ...
                        <button
                          ...
                          className="px-6 py-2 bg-pink-600 hover:bg-pink-700 disabled:bg-white/10 text-white rounded-lg font-medium transition-colors"
                        >
            ...
            {cart.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-pink-600 hover:bg-pink-700 disabled:bg-pink-800 text-white font-bold rounded-lg transition-colors"
                >

...
export default function LadyGagaEventPage() {
              ...
              >
                ...
                {getCartQuantity() > 0 && (
                  <div className="border-t border-gray-700 pt-4 mb-4">
                    <h3 className="text-lg font-semibold mb-3 text-white">Complete Your Experience</h3>
                    <div className="grid grid-cols-2 gap-3">
                      {featuredMerch.map((item) => (
                        <div key={item.id} className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
                          ...
                          />
                          <h4 className="font-medium text-sm text-white mb-1">{item.name}</h4>
                          <p className="text-xs text-gray-400 mb-2">{item.description}</p>
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-semibold text-primary">${item.price}</span>
                            <button
                              onClick={() => addMerchandiseToCart(item, 1)}

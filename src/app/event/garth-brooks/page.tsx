  ...
  useEffect(() => {
    setTimeout(() => {
      setEventData({
        ...
        artist: 'Garth Brooks',
        venue: 'Nashville Arena, Nashville',
        date: '2025-11-20',
        time: '19:30',
        description: 'Join country music legend Garth Brooks for an unforgettable evening of classic hits and new favorites. Experience the magic of live country music with one of the best-selling artists of all time.',
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative">
        <div className="h-64 bg-gradient-to-r from-amber-700 to-orange-600 flex items-center">

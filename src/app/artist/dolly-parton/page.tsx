...
export default function DollyPartonArtistPortal() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-800 via-purple-800 to-indigo-900 flex items-center justify-center">
  ...
  const eventData = {
    ...
    venue: event?.venue || 'Grand Ole Opry',
    date: event?.date || '2025-09-25',

      ...
      <div className="bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-6">
            ...
            />
            <div>
              <h1 className="text-3xl font-bold text-white">Taylor Swift</h1>
              <p className="text-white/70">Artist Portal - The Eras Tour</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              >
                ...
                <p className="text-green-400 text-sm mt-1">↗ 18% from last event</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-blue-400 text-sm mt-1">of 1,200 available</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-3xl font-bold text-pink-300">${totalCharityRaised.toLocaleString()}</p>
                <p className="text-pink-400 text-sm mt-1">Current uplift: {upliftPercentage}%</p>
              </motion.div>
            </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-pink-300">Charity Donations</span>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-pink-300">{Math.round(totalCharityRaised / 75)}</p>
              <p className="text-white/60 text-sm">Literacy programs funded</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-pink-300">{Math.round(totalCharityRaised / 150)}</p>
              <p className="text-white/60 text-sm">Reading books provided</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-pink-300">{Math.round(totalCharityRaised / 300)}</p>
              <p className="text-white/60 text-sm">Teacher training sessions</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-pink-300">{ticketsSold}</p>

...
export default function GarthBrooksArtistPortal() {
  const [upliftPercentage, setUpliftPercentage] = useState(8);
  const [basePrice, setBasePrice] = useState(125);
  const [totalRevenue, setTotalRevenue] = useState(98500);
  const [ticketsSold, setTicketsSold] = useState(788);
  ...
  return (
    <AdminPasswordProtection>
      ...
      <div className="bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-6">
            ...
            />
            <div>
              <h1 className="text-3xl font-bold text-white">Garth Brooks</h1>
              <p className="text-white/70">Artist Portal - Country Roads Tour</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-white/10 rounded-lg p-3 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Rural Education Foundation</p>
                      <p className="text-white/60 text-xs">Supporting rural communities</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              >
                ...
                <p className="text-green-400 text-sm mt-1">↗ 8% from last event</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-blue-400 text-sm mt-1">of 950 available</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-3xl font-bold text-amber-300">${totalCharityRaised.toLocaleString()}</p>
                <p className="text-amber-400 text-sm mt-1">Current uplift: {upliftPercentage}%</p>
              </motion.div>
            </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-amber-300">Charity Donations</span>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-amber-300">{Math.round(totalCharityRaised / 100)}</p>
              <p className="text-white/60 text-sm">School supplies funded</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-amber-300">{Math.round(totalCharityRaised / 500)}</p>
              <p className="text-white/60 text-sm">Student scholarships</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-amber-300">{Math.round(totalCharityRaised / 250)}</p>
              <p className="text-white/60 text-sm">Library books donated</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-amber-300">{ticketsSold}</p>
      ...
      <style jsx>{`
        .slider {
          background: linear-gradient(to right, #f59e0b 0%, #f59e0b ${upliftPercentage}%, rgba(255,255,255,0.2) ${upliftPercentage}%, rgba(255,255,255,0.2) 100%);
        }
